...
!(function (t) {
  ...
  function (t, e, n) {
    ...
    function o(t, e, n) {
      for (var o = 0; o < t.length; o++) {
        var a,
          s = t[o],
          f = (0, c.default)(e, s.options);
        a = f.displayValue ? u(s.text, f, n) : 0;
        var l = s.data.length * f.width;
        (s.width = Math.ceil(Math.max(a, l))),
          (s.height = r(s, f)),
          (s.barcodePadding = i(a, l, f));
      }
    }
    function a(t) {
    ...
    (e.getMaximumHeightOfEncodings = s),
      ...
      (e.calculateEncodingAttributes = o),
  ...
  function (t, e, n) {
    ...
    function i(t) {
      ...
      if (t && "object" === (void 0 === t ? "undefined" : s(t)) && !t.nodeName)
  ...
  function (t, e, n) {
    ...
    function i(t, e, n) {
      ...
      for (var o = 0; o < i.length; o++)
        i[o].options = (0, c.default)(n, i[o].options);
      return i;
    }
    function o() {
      return u.default.CODE128 ? "CODE128" : Object.keys(u.default)[0];
    }
    function a(t, e, n) {
      e = (0, d.default)(e);
    ...
    var s = n(5),
      ...
      E = function (t, e, n) {
        ...
        return (
          ...
          (r._encodings = []),
          (r._options = O.default),
          (r._errorHandler = new w.default(r)),
          void 0 !== e &&
            ((n = n || {}),
            n.format || (n.format = o()),
    ...
    for (var P in u.default)
      u.default.hasOwnProperty(P) &&
        (function (t, e) {
          A.prototype[e] =
            A.prototype[e.toUpperCase()] =
            A.prototype[e.toLowerCase()] =
              function (n, r) {
                var o = this;
    ...
    (A.prototype.options = function (t) {
      ...
      (A.prototype.init = function () {
        if (this._renderProperties) {
          ...
          for (var e in this._renderProperties) {
            ...
            "auto" == n.format && (n.format = o()),
              this._errorHandler.wrapBarcodeCall(function () {
                var e = n.value,
                  r = u.default[n.format.toUpperCase()],
                  o = i(e, r, n);
                a(t, o, n);
              });
          }
      ...
      (A.prototype._defaults = O.default),
              ...
              value: function (t, e) {
                ...
                for (var o = 0; o < i.length; o++) {
                  ...
                  "1" === i[o]
                    ...
                    : i[o] && r.fillRect(a, n, t.width, t.height * i[o]);
                }
              },
            },
            {
          ...
          i(t, [
            ...
            },
            {
              ...
              value: function () {
                ...
                var t = (0, s.getTotalWidthOfEncodings)(this.encodings),
                  e = (0, s.getMaximumHeightOfEncodings)(this.encodings),
            ...
            },
            {
              ...
              value: function (t, e, n) {
                ...
                for (var o = 0, a = 0, s = 0; s < i.length; s++)
            ...
            },
            {
              key: "drawSVGText",
              value: function (t, e, n) {
                var r = this.document.createElementNS(u, "text");
                if (e.displayValue) {
                  var i, o;
                  r.setAttribute(
                    "style",
            ...
            },
            {
              key: "createGroup",
              value: function (t, e, n) {
                var r = this.document.createElementNS(u, "g");
                return (
                  r.setAttribute(
                    "transform",
                    "translate(" + t + ", " + e + ")"
